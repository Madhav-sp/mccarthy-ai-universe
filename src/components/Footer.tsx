    ...
    <footer className="border-t border-border/40 bg-background py-8 md:py-12">
      <div className="container px-4 md:px-6">
        <div className="grid grid-cols-2 gap-8 md:grid-cols-4 lg:grid-cols-5">
          ...
          <div>
            <h3 className="font-medium text-sm mb-3">Explore</h3>
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li><Link to="/explore" className="hover:text-foreground">All Tools</Link></li>
              <li><Link to="/explore" className="hover:text-foreground">Categories</Link></li>
              <li><Link to="/explore" className="hover:text-foreground">Popular</Link></li>
              <li><Link to="/explore" className="hover:text-foreground">New Releases</Link></li>
            </ul>
          </div>
          <div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li><Link to="/" className="hover:text-foreground">Licenses</Link></li>
            </ul>
          </div>
        </div>
        <div className="mt-10 flex flex-col border-t border-border pt-6 md:flex-row md:items-center md:justify-between">
